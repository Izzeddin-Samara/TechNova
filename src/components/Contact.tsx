    ...
    <>
      <div className=" max-w-7xl mx-auto h-auto p-8 ">
        ...
        <div className="w-full">
          <div className="max-w-7xl bg-gray-100 mx-auto h-auto ">
            <div className="grid grid-cols-1 sm:grid-col-2 lg:grid-cols-2 gap-8">
              <div>
                <form className="space-y-6 p-4" onSubmit={handleSubmit}>
                  <div>
                    ...
                    <input
                      className="w-full p-3 bg-gray-200 outline-none border border-gray-300 rounded-lg mt-2 focus:ring-3 focus:ring-cyan-600"
                      type="text"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      className="w-full p-3 bg-gray-200  border rounded-lg outline-none border border-gray-300 mt-2 focus:ring-3 focus:ring-cyan-600"
                      type="text"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      className="w-full h-48 p-3 bg-gray-200 border outline-none rounded-lg border-gray-300 mt-2 resize-none focus:ring-3 focus:ring-cyan-600"
                      name="Message"
                      id=""
                    ></textarea>
                  </div>
              ...
              <div className="space-y-8 mt-10">
                ...
                <div className="text-center">
                  ...
                  <p className="text-cyan-700 font-bold mt-4">+123-456-7890</p>
                </div>
              </div>
            </div>
          </div>
