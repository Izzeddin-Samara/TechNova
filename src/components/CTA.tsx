  ...
  return (
    <>
      <div className="mt-50 text-center w-full">
        ...
        <Link to="/contact">
          <button className="bg-cyan-700 font-bold hover:bg-cyan-800 p-4 w-1/5 mt-8  text-2xl text-white rounded-lg focus:ring-4 focus:ring-cyan-500 cursor-pointer">
            Contact Us now!
          </button>
        </Link>
      </div>
